...
export default {
    ...
    theme: {
        colors: {
            primary: '#9B9B7A', // Main green color, used as the primary color in the theme
            accent: '#BAA587', // Lighter green color for accents
            background: '#797D62', // Background color for general app background
            surface: '#FAEDCD', // Surface color for elements like cards and menus
            text: '#FFCB69', // Main text color, offering high contrast on light backgrounds
